...
if __name__ =='__main__':
    ...
    df_Arc,df_Arc_sorted  = ARC.readArc_csv(filename)
    df_moteus, df_moteus_sorted = Moteus.process_csv_files(filenames)
    Power_MoteusVsARC(df_Arc_sorted,df_moteus_sorted)
    MoteusVsARC_predictions(df_Arc_sorted, df_moteus_sorted, speed= 15000)
